...
COUNTY_DATABASE_PLACEHOLDER = {
    "Allegany County": {
        "name": "Allegany County",
        "summerTemp": 83, "winterTemp": 28,
        "averageCostOfLiving": 1550,
        "crimeSafety": "Medium", "schoolQuality": "Medium",
        "diversityPercent": 14
    },
    "Anne Arundel County": {
        "name": "Anne Arundel County",
        "summerTemp": 87, "winterTemp": 32,
        "averageCostOfLiving": 2400,
        "crimeSafety": "Medium", "schoolQuality": "High",
        "diversityPercent": 32
    },
    "Baltimore County": {
        "name": "Baltimore County",
        "summerTemp": 86, "winterTemp": 31,
        "averageCostOfLiving": 2100,
        "crimeSafety": "High", "schoolQuality": "Medium",
        "diversityPercent": 43
    },
    "Calvert County": {
        "name": "Calvert County",
        "summerTemp": 87, "winterTemp": 34,
        "averageCostOfLiving": 2350,
        "crimeSafety": "Low", "schoolQuality": "High",
        "diversityPercent": 22
    },
    "Caroline County": {
        "name": "Caroline County",
        "summerTemp": 88, "winterTemp": 33,
        "averageCostOfLiving": 1700,
        "crimeSafety": "Medium", "schoolQuality": "Low",
        "diversityPercent": 25
    },
    "Carroll County": {
        "name": "Carroll County",
        "summerTemp": 85, "winterTemp": 29,
    ...
    "Charles County": {
        "name": "Charles County",
        "summerTemp": 88, "winterTemp": 34,
        "averageCostOfLiving": 2400,
        "crimeSafety": "Low", "schoolQuality": "Medium",
        "diversityPercent": 60
    },
    "Dorchester County": {
        ...
        "crimeSafety": "High", "schoolQuality": "Low",
        "diversityPercent": 37
    },
    "Frederick County": {
        "name": "Frederick County",
        "summerTemp": 85, "winterTemp": 30,
...
# ---------------------------------------------------
# Crime & School explanations (per county)
# ---------------------------------------------------
COUNTY_EXPLANATIONS = {
    "Allegany County": {
        "crime": "Allegany County has moderate crime rates, largely concentrated in Cumberland city. Rural areas are generally safe, but property crime in the urban core keeps the rating at medium.",
        "school": "Schools here are improving but still face funding challenges tied to the county's economic decline from the coal industry. Test scores and graduation rates are near the state average."
    },
    "Anne Arundel County": {
        "crime": "Anne Arundel has a mixed profile — suburban areas near Annapolis and Severna Park are quite safe, while parts of Glen Burnie see higher property crime rates, keeping the overall rating at medium.",
        "school": "Home to some of Maryland's top-ranked schools, Anne Arundel benefits from strong county funding and a well-regarded school administration. Many schools score above state averages."
    },
    "Baltimore County": {
        "crime": "Baltimore County (separate from Baltimore City) has elevated crime in areas like Dundalk and Owings Mills, driven by proximity to urban centers. Suburban pockets are safer but the county average sits high.",
        "school": "Schools vary significantly by area — affluent communities like Towson have excellent schools, while western parts of the county lag. Overall performance is mid-tier for Maryland."
    },
    "Calvert County": {
        "crime": "Calvert is one of Maryland's safest counties. Its rural character, tight-knit communities, and limited urban density contribute to very low crime rates across the board.",
        "school": "Calvert County Public Schools consistently earn top marks, with high graduation rates, strong SAT/ACT scores, and well-funded programs. A great choice for families prioritizing education."
    },
    "Caroline County": {
        "crime": "Crime rates are moderate for Caroline County. While overall violent crime is low, property crime in Denton and economic stressors in rural areas keep safety at an average level.",
        "school": "Caroline County schools face challenges from limited funding and rural poverty. Graduation rates and standardized test performance fall below the Maryland state average."
    },
    "Carroll County": {
        "crime": "Carroll County is among Maryland's safest, with very low rates of both violent and property crime. Its largely rural, suburban landscape and stable community fabric drive this strong safety record.",
        "school": "Carroll County schools rank highly across Maryland. Strong community investment, low student-to-teacher ratios, and high parental involvement result in excellent academic outcomes."
    },
    "Cecil County": {
        "crime": "Cecil County sees moderate crime, with higher rates near Elkton along major highway corridors. Suburban and rural areas are comparatively safer, balancing out the county's overall rating.",
        "school": "Cecil County schools offer average quality for Maryland. Resources are sufficient but not exceptional, and performance varies between rural schools and those near the Pennsylvania border."
    },
    "Charles County": {
        "crime": "Charles County maintains low crime rates thanks to strong suburban development, active community policing, and a growing middle-class population relocating from the DC metro area.",
        "school": "Schools in Charles County are solid, with improving graduation rates and several highly-rated magnet programs. The district benefits from a growing tax base and community engagement."
    },
    "Dorchester County": {
        "crime": "Dorchester County has above-average crime rates, particularly in Cambridge. Economic challenges, high poverty levels, and limited social services contribute to elevated property and violent crime.",
        "school": "Schools in Dorchester face serious funding and performance challenges. High poverty rates, low graduation rates, and below-average test scores make it one of Maryland's weaker school districts."
    },
    "Frederick County": {
        "crime": "Frederick County is one of Maryland's safest larger counties. Rapid suburban growth has brought investment and strong policing. Both violent and property crime rates remain well below state averages.",
        "school": "Frederick County Public Schools are consistently top-rated in Maryland. Strong funding, excellent teacher retention, and a growing, educated population all contribute to outstanding academic performance."
    },
    "Garrett County": {
        "crime": "Garrett County has very low crime rates. Its remote, rural mountain setting means a small, tight-knit population and minimal criminal activity — one of Maryland's safest counties.",
        "school": "Schools in Garrett County are adequate but limited by rural isolation and a small tax base. Performance is middle-of-the-road for Maryland, though the community values education highly."
    },
    "Harford County": {
        "crime": "Harford County is a safe suburban county. Low violent crime and moderate property crime, combined with strong community policing near Aberdeen Proving Ground, keep safety ratings favorable.",
        "school": "Harford County schools perform well, supported by military-community investment and stable suburban funding. Several schools rank among the state's best, especially at the high school level."
    },
    "Howard County": {
        "crime": "Howard County is among Maryland's safest counties. Excellent community resources, high median incomes, and proactive law enforcement contribute to consistently low crime across the county.",
        "school": "Howard County Public School System is nationally recognized as one of the best in the country. Exceptional funding, diverse magnet programs, and high academic standards make it Maryland's top school district."
    },
    "Kent County": {
        "crime": "Kent County has low crime rates characteristic of its small, rural Eastern Shore community. Chestertown is a peaceful college town environment that keeps overall crime minimal.",
        "school": "Kent County schools are average for Maryland. The rural district has a small student population and limited resources, though teachers are dedicated and graduation rates are acceptable."
    },
    "Montgomery County": {
        "crime": "Montgomery County has low crime relative to its large population and proximity to DC. Robust county resources, diverse community programs, and strong policing keep it among Maryland's safest major counties.",
        "school": "Montgomery County Public Schools is one of the largest and most celebrated school systems in the nation. Top-ranked nationally, it offers exceptional magnet programs, high diversity, and outstanding academic results."
    },
    "Prince George's County": {
        "crime": "Prince George's County has moderate crime rates — higher near urban centers like Hyattsville and Landover, but safer in suburban areas like Bowie and College Park. Crime has improved significantly in recent years.",
        "school": "Schools in Prince George's County are improving under ongoing reform efforts. Performance varies widely across the district, with some schools excelling while others in lower-income areas face persistent challenges."
    },
    "Queen Anne's County": {
        "crime": "Queen Anne's County is very safe, benefiting from a low-density rural and suburban mix. Crime rates are among the lowest on Maryland's Eastern Shore, with minimal violent crime reported.",
        "school": "Queen Anne's County schools perform well above the state average. Small class sizes, engaged parents, and solid county investment make it one of the Eastern Shore's best school systems."
    },
    "Saint Mary's County": {
        "crime": "Saint Mary's County has low crime rates, influenced by a stable military and government workforce centered around NAS Patuxent River. Community cohesion keeps both violent and property crime low.",
        "school": "Schools in Saint Mary's County are solid and well-funded relative to their size. Military family presence contributes to school stability, though performance is average-to-good compared to statewide rankings."
    },
    "Somerset County": {
        "crime": "Somerset County has moderate crime despite its small size. Economic hardship and high poverty rates in Princess Anne contribute to above-average crime for a rural county.",
        "school": "Somerset County schools are among Maryland's lowest-ranked. Deep rural poverty, low funding, and high student need create persistent educational challenges, with graduation rates and test scores below state averages."
    },
    "Talbot County": {
        "crime": "Talbot County has low crime rates overall. Easton is a prosperous small city with active policing, and the rural areas around it are peaceful. Property crime is minimal.",
        "school": "Talbot County schools perform at or slightly above the Maryland average. The district is small but benefits from the county's above-average household incomes and involved community members."
    },
    "Washington County": {
        "crime": "Washington County has moderate crime, concentrated in Hagerstown. Urban economic stress and proximity to I-81 drug corridors contribute to higher property crime, while rural areas remain safe.",
        "school": "Washington County schools are average for Maryland. The district faces challenges from poverty in Hagerstown but has invested in vocational and technical education programs that serve the community well."
    },
    "Wicomico County": {
        "crime": "Wicomico County has above-average crime rates, particularly in Salisbury. Urban density, poverty, and a transient population near Salisbury University contribute to elevated violent and property crime.",
        "school": "Wicomico County schools face significant challenges. Limited funding, high poverty rates among students, and below-average test scores put the district in the lower tier of Maryland school systems."
    },
    "Worcester County": {
        "crime": "Worcester County sees elevated crime largely due to Ocean City's seasonal tourism economy. High summer foot traffic drives up property crime and DUI incidents, skewing the annual statistics.",
        "school": "Worcester County schools perform at a medium level. The resort economy limits long-term educational investment, though small class sizes and dedicated staff provide reasonable academic outcomes."
    },
    "Baltimore City": {
        "crime": "Baltimore City has some of the highest crime rates in the nation, particularly for violent crime. Concentrated poverty, historical disinvestment, and limited economic opportunity in many neighborhoods drive these rates — though waterfront and inner-harbor areas have improved significantly.",
        "school": "Baltimore City Public Schools face systemic challenges including underfunding, aging infrastructure, and high student poverty rates. While some magnet and charter schools perform excellently, the overall district lags well behind state and national averages."
    }
}
...
# ---------------------------------------------------
RACE_BREAKDOWN = {
    "Allegany County": {"white": 87.3, "black": 8.0, "hispanic": 1.7, "asian": 1.0, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 1.7},
    "Anne Arundel County": {"white": 69.5, "black": 16.3, "hispanic": 7.3, "asian": 3.9, "american_indian": 0.3, "native_hawaiian": 0.1, "multiracial": 2.6},
    "Baltimore City": {"white": 28.3, "black": 62.1, "hispanic": 4.8, "asian": 2.7, "american_indian": 0.3, "native_hawaiian": 0.0, "multiracial": 1.8},
    "Baltimore County": {"white": 58.8, "black": 27.5, "hispanic": 5.2, "asian": 6.0, "american_indian": 0.3, "native_hawaiian": 0.0, "multiracial": 2.1},
    "Calvert County": {"white": 78.8, "black": 12.9, "hispanic": 3.7, "asian": 1.6, "american_indian": 0.3, "native_hawaiian": 0.1, "multiracial": 2.6},
    "Caroline County": {"white": 76.5, "black": 14.0, "hispanic": 6.6, "asian": 0.8, "american_indian": 0.3, "native_hawaiian": 0.0, "multiracial": 1.7},
    "Carroll County": {"white": 89.9, "black": 3.5, "hispanic": 3.2, "asian": 1.8, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 1.5},
    "Cecil County": {"white": 85.5, "black": 6.7, "hispanic": 4.2, "asian": 1.2, "american_indian": 0.3, "native_hawaiian": 0.1, "multiracial": 2.0},
    "Charles County": {"white": 43.2, "black": 43.9, "hispanic": 5.5, "asian": 3.3, "american_indian": 0.6, "native_hawaiian": 0.1, "multiracial": 3.4},
    "Dorchester County": {"white": 64.0, "black": 27.7, "hispanic": 4.9, "asian": 1.2, "american_indian": 0.3, "native_hawaiian": 0.0, "multiracial": 1.8},
    "Frederick County": {"white": 75.0, "black": 9.0, "hispanic": 8.7, "asian": 4.5, "american_indian": 0.2, "native_hawaiian": 0.1, "multiracial": 2.5},
    "Garrett County": {"white": 96.4, "black": 1.1, "hispanic": 1.1, "asian": 0.5, "american_indian": 0.1, "native_hawaiian": 0.0, "multiracial": 0.8},
    "Harford County": {"white": 77.0, "black": 13.1, "hispanic": 4.3, "asian": 3.1, "american_indian": 0.2, "native_hawaiian": 0.1, "multiracial": 2.3},
    "Howard County": {"white": 54.2, "black": 18.3, "hispanic": 6.5, "asian": 17.5, "american_indian": 0.2, "native_hawaiian": 0.1, "multiracial": 3.2},
    "Kent County": {"white": 78.2, "black": 14.8, "hispanic": 4.3, "asian": 1.0, "american_indian": 0.1, "native_hawaiian": 0.0, "multiracial": 1.5},
    "Montgomery County": {"white": 45.2, "black": 17.8, "hispanic": 19.0, "asian": 15.2, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 2.6},
    "Prince George's County": {"white": 13.9, "black": 62.1, "hispanic": 17.2, "asian": 4.5, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 2.0},
    "Queen Anne's County": {"white": 86.5, "black": 6.8, "hispanic": 3.6, "asian": 1.1, "american_indian": 0.3, "native_hawaiian": 0.0, "multiracial": 1.8},
    "Saint Mary's County": {"white": 74.9, "black": 14.1, "hispanic": 4.9, "asian": 2.8, "american_indian": 0.3, "native_hawaiian": 0.1, "multiracial": 2.9},
    "Somerset County": {"white": 51.5, "black": 41.7, "hispanic": 3.5, "asian": 0.9, "american_indian": 0.4, "native_hawaiian": 0.0, "multiracial": 2.0},
    "Talbot County": {"white": 78.2, "black": 12.7, "hispanic": 6.3, "asian": 1.3, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 1.4},
    "Washington County": {"white": 80.4, "black": 10.7, "hispanic": 4.5, "asian": 1.8, "american_indian": 0.2, "native_hawaiian": 0.1, "multiracial": 2.4},
    "Wicomico County": {"white": 64.1, "black": 25.0, "hispanic": 5.2, "asian": 3.2, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 2.3},
    "Worcester County": {"white": 79.9, "black": 13.4, "hispanic": 3.4, "asian": 1.4, "american_indian": 0.2, "native_hawaiian": 0.0, "multiracial": 1.6},
}

# Attach race breakdown
...
Never make up data — use the snapshot above for this county and general knowledge for others."""
    ...
    try:
        ...
        api_key = "AIzaSyABSxRF0l_OkQ5RewVfhX69Ipk4PHnLrSM"
